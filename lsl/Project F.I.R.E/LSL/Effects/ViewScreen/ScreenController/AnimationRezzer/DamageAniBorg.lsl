string object = "damage (ani) - borg"; // Name of object in inventory
vector relativePosOffset = <-0.1, 0.0, -1.3>; // "Forward" and a little "above" this prim
