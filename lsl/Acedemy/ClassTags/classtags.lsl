/*
classtags.lsl
Program designed to demonstrate Titler Tags in the classroom durring orientation Starfleet Delta
...
// TODO:
// 1) Listen to md5 encrypted channel numbers based on discription text 
// 2) Listen for CLEAR event from same channel
// 3) Remove listen on chanel 899. [ we dont want to reset and send a tag pull every time actual titlers get reset ]
